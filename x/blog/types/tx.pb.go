...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "clockworkgr.spvue.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "clockworkgr.spvue.blog.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "clockworkgr.spvue.blog.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "clockworkgr.spvue.blog.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "clockworkgr.spvue.blog.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "clockworkgr.spvue.blog.MsgDeletePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clockworkgr.spvue.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clockworkgr.spvue.blog.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clockworkgr.spvue.blog.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clockworkgr.spvue.blog.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clockworkgr.spvue.blog.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clockworkgr.spvue.blog.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "clockworkgr.spvue.blog.Msg",
