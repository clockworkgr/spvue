...
func NewMsgCreatePost(creator string, title string, body string, votes int32) *MsgCreatePost {
...
func NewMsgUpdatePost(creator string, id string, title string, body string, votes int32) *MsgUpdatePost {
